...
export function ProcessSection() {
  ...
  return (
    <section
      id="process"
      className="scroll-mt-24 relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#050505] to-black overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="neon-process-card relative p-6 rounded-2xl transition-all duration-500 bg-white/[0.04] backdrop-blur-md border border-white/60">
