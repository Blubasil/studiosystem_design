  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto pt-[20px] sm:pt-0">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight mb-4 mt-[20px] sm:mt-0 animate-fade-in-up delay-100">
            {t.hero.title1}
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto animate-fade-in-up delay-400">
            <div className="hero-feature-pill grid grid-cols-[48px_1fr] items-center gap-3 sm:flex sm:items-center sm:justify-center py-4 px-5 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl mx-auto w-full max-w-sm sm:max-w-none">
