...
/** Bump ?v= when replacing `public/focus-pillar-apps.png` so browsers/CDNs fetch the new file. */
const APPS_PILLAR_IMAGE = "/focus-pillar-apps.png?v=2"
...
const images = [
  { src: APPS_PILLAR_IMAGE, key: "pillar1" as const, altKey: "imageAlt1" as const },
